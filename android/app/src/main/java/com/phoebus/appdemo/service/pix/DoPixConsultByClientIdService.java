...
import com.phoebus.appdemo.model.pix.ConsultCobByClientIdRequest;
...
public class DoPixConsultByClientIdService implements OnBindConnectedPixServices {
    ...
    public DoPixConsultByClientIdService(ReactContext context, PixClient pixClient, String pixClientId, Promise promise){
    ...
    public void execute() {
        Gson gson = new Gson();
        if(mPixClient.isBound() && !pixClientId.isEmpty()){
            ConsultCobByClientIdRequest consultCobByClientIdRequest = new ConsultCobByClientIdRequest();
            consultCobByClientIdRequest.pixClientId = pixClientId;

                try {
                    mPixClient.consultByPixClientId(gson.toJson(consultCobByClientIdRequest, ConsultCobByClientIdRequest.class),  new  PixClient.ConsultByPixClientIdCallback (){
                        @Override
