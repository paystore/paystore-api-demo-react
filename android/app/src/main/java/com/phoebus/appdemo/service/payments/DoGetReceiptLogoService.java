...
public class DoGetReceiptLogoService implements OnBindConnectedPaymentService {
    private final ReactContext context;
    private final Promise promise;
    private final PaymentClient paymentClient;

    public DoGetReceiptLogoService(ReactContext context, PaymentClient paymentClient, Promise promise){
    ...
    public void execute() {
        ...
        try {
           this.paymentClient.getReceiptLogo(new PaymentClient.PaymentCallback<Object>() {
               @Override
            ...
            Log.e(Constants.TAG, "Erro ao obter a logo do comprovante", e);
