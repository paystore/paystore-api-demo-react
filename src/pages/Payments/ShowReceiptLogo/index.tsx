...
import { Container, ReceiptView } from './style';
...
export default function ShowReceiptLogo(props: Readonly<ShowLogoScreenProps>) {
  ...
  useEffect(() => {
    async function getLogo() {
      try {
        const response = await Payment.getReceiptLogo();
